# LP -- Maria Jose Moura Santana

Repositorio standalone da landing page de Maria Jose Moura Santana.
...
- **Cliente:** Maria Jose Moura Santana
- **GitHub:** https://github.com/emaildozotti/Maria-Jos-Moura-Santana
- **Vercel:** https://maria-jose-santana.vercel.app
...
```bash
git commit -m "feat: foto e video inseridos -- Maria Jose Moura Santana ao ar"
...
- O remote `origin` = `emaildozotti/Maria-Jos-Moura-Santana` -- nao alterar
